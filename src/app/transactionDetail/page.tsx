...
import CCTPLogo from '../transfer/components/Icon/CCTPLogo'
...
export default function TransactionDetail () {
  ...
  let isCross =
    transactionDetail?.extraInfo?.length &&
    transactionDetail?.extraInfo[0]?.type === 'crossChain'
  return (
    <MainLayout showMenu={false}>
      <div className='flex flex-col h-full'>
        <Header title='Transaction Detail' showBack />
          ...
          <div className='py-4 w-full'>
            ...
            <div className='w-full flex items-center justify-center border-b-1 border-gray-500/30 px-6 pb-4'>
              <Person
                ...
                value={
                  isSwap || isCross
                    ? transactionDetail.extraInfo[0].amount
                    : null
                }
                token={
                  isSwap || isCross
              ...
              />
              {isSwap ? (
                <div className=' flex items-center relative h-[1.25rem]'>
                  <svg
                    className='w-13'
                    width='82'
                    height='24'
                ...
                <div className=' flex items-center relative h-[1.25rem]'>
                  ...
                  <div className='flex flex-col items-center h-[88px]'>
                    <p className='font-bold text-base p-1 font-mono text-center'>
                      CCTP
                    </p>
                    <p className='font-bold text-base p-1 font-mono text-[#4FAAEB] whitespace-nowrap'>
                      <CCTPLogo></CCTPLogo>
                    </p>
                    <p className='bg-[#819DF54D] text-[#819DF5] absolute bottom-[-33px] rounded-full text-xs px-2 py-1 whitespace-nowrap'>
                      Cross-Chain Bridge
                    </p>
                  </div>
                  <svg
              ...
              <Person
                ...
                value={
                  isSwap
                    ? transactionDetail.extraInfo[1].amount
                    : isCross
                    ? transactionDetail.extraInfo[0].amount
                    : null
                }
